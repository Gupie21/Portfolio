            ...
            <div className="portfolio__card" key={item.img}>
              ...
              <div className="portfolio__card-content">
                ...
                <div className="portfolio-card-content--cta">
                  <a className="portfolio-cta" href={item.clink} target="_blank" rel="noreferrer"><i className="fa-solid fa-user"></i></a>
                  <a className="portfolio-cta" href={item.clink} target="_blank" rel="noreferrer"><OpenInNewIcon /></a>
                </div>
              </div>
            </div>
          );
...
const featureData = [
  {
    ...
    description: "Build a site in a Laravel environment with Wordpress that allows people to learn more about this institution, its certifications, seminars and courses through a friendly and intuitive platform. ",
  ...
  },
  {
    ...
    description: "Build and design a Wordpress multisite site that hosts vendors, sellers and users in a custom marketplace programmed with SCSS, PHP and Javascript.",
    tech: "Woocommerce | PHP | Javascript | SCSS| AWS Lightsail | Adobe CC",
  ...
  },
  {
    ...
    description: "Lead and build a project hand in hand with Mabe's designers a site mounted on SAP Hybris for the sale of products of the brand, taking into account the needs of the company and creating a good UX for end users of this platform.",
  ...
  },
  {
    ...
    description: "Visually improve the platform through end-user testing, taking into account the target market and best practices for the generation of a new UI on your sales site.",
    tech: "SCSS | Javascript | Hybris(Java) | Balsamiq | Adobe CC",
